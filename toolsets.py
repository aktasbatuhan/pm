...
# MCP tools (GitHub, Linear, PostHog, etc.) are auto-discovered at startup
# and don't need to be listed here.
_PM_CORE_TOOLS = [
    # Web research
    "web_search", "web_extract",
    # Terminal + process management (run scripts, check repos)
    "terminal", "process",
    # File manipulation (reports, exports, configs)
    "read_file", "write_file", "patch", "search_files",
    # Vision (analyze screenshots, charts, diagrams)
    "vision_analyze",
    # Skills (self-improving knowledge base)
    ...
    "workspace_get_learnings", "workspace_add_learning",
    ...
    # PM Fleet — delegated coding-agent activity summary for the brief
    "fleet_activity_summary", "fleet_refile_delegation",
    # Cross-platform messaging (gated on gateway running via check_fn)
    "send_message",
]

# Backward compat alias
_KAI_CORE_TOOLS = _PM_CORE_TOOLS
...
TOOLSETS = {
    ...
    # ==========================================================================
    # Dash PM toolsets (CLI + messaging platforms)
    #
    # All platforms share the same core tools. MCP tools are auto-discovered
    # at startup and available on all platforms.
    # ==========================================================================

    "kai-cli": {
        "description": "Dash PM CLI - full toolset for interactive use",
        "tools": _KAI_CORE_TOOLS,
        "includes": []
    },

    # Sandbox toolset: simulates the E2B environment where the agent has
    # MCP tools + skills + memory but no local codebase access.
    # Use for testing onboarding: python cli.py --toolset kai-sandbox
    "kai-sandbox": {
        "description": "Dash PM sandbox - MCP tools + skills, no local filesystem access",
        "tools": [
            "skills_list", "skill_view", "skill_manage",
    ...
    "kai-slack": {
        "description": "Dash PM Slack bot - always-on product management assistant",
        "tools": _KAI_CORE_TOOLS,
        "includes": []
    },

    "kai-discord": {
        "description": "Dash PM Discord bot - community product management assistant",
        "tools": _KAI_CORE_TOOLS,
        "includes": []
    },

    "kai-telegram": {
        "description": "Dash PM Telegram bot - personal product management assistant",
        "tools": _KAI_CORE_TOOLS,
        "includes": []
    },

    "kai-email": {
        "description": "Dash PM email bot - async product management via email",
        "tools": _KAI_CORE_TOOLS,
        "includes": []
    },
    ...
    "kai-gateway": {
        ...
        "tools": [],
        "includes": ["kai-slack", "kai-discord", "kai-telegram", "kai-email"]
    },

    # Backward compat: keep hermes- prefixed names pointing to kai equivalents
    "hermes-cli": {
        "description": "Alias for kai-cli",
        "tools": _KAI_CORE_TOOLS,
        "includes": []
    },
    "hermes-slack": {
        "description": "Alias for kai-slack",
        "tools": _KAI_CORE_TOOLS,
        "includes": []
    },
    "hermes-telegram": {
        "description": "Alias for kai-telegram",
        "tools": _KAI_CORE_TOOLS,
        "includes": []
    },
    "hermes-discord": {
        "description": "Alias for kai-discord",
        "tools": _KAI_CORE_TOOLS,
        "includes": []
    },
    "hermes-gateway": {
        "description": "Alias for kai-gateway",
        "tools": [],
        "includes": ["kai-slack", "kai-discord", "kai-telegram", "kai-email"]
    }
}
