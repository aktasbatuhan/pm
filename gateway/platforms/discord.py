...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="ask", description="Ask Dash a question")
        ...
        @tree.command(name="reset", description="Reset your Dash session")
        ...
        @tree.command(name="status", description="Show Dash session status")
        ...
        @tree.command(name="stop", description="Stop the running Dash agent")
        ...
        @tree.command(name="update", description="Update Dash PM to the latest version")
