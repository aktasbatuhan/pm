...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Kai Agent — steel blue and rose",
        "colors": {
        ...
        "branding": {
            "agent_name": "Kai Agent",
            "welcome": "Kai Agent ready. Type your message or /help for commands.",
            "goodbye": "Session ended.",
            "response_label": " ◆ Kai ",
            "prompt_symbol": "◆ ",
            "help_header": "Kai Agent Commands",
        },
        "tool_prefix": "┊",
    },
    "ares": {
