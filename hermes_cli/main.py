...
Usage:
    ...
    kai uninstall           # Uninstall Kai Agent
...
def cmd_whatsapp(args):
    ...
    if (session_dir / "creds.json").exists():
        ...
        if wa_mode == "bot":
            ...
            print()
            print("  Tip: Agent responses are prefixed with '◆ Kai Agent'")
        else:
            print("  Next steps:")
            print("    1. Start the gateway:  kai gateway")
...
def cmd_version(args):
    """Show version."""
    print(f"Kai Agent v{__version__} ({__release_date__})")
...
def _update_via_zip(args):
    """Update Kai Agent by downloading a ZIP archive.
...
def cmd_update(args):
    """Update Kai Agent to the latest version."""
    import subprocess
    import shutil
    
    print("◆ Updating Kai Agent...")
    print()
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="kai",
        description="Kai Agent - AI-powered security & optimization research assistant",
...
"""
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with Kai Agent"
    )
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Kai Agent with an interactive wizard. "
    ...
    status_parser = subparsers.add_parser(
        ...
        description="Display status of Kai Agent components"
    )
    ...
    doctor_parser = subparsers.add_parser(
        ...
        description="Diagnose issues with Kai Agent setup"
    )
    ...
    config_parser = subparsers.add_parser(
        ...
        description="Manage Kai Agent configuration"
    )
    ...
    update_parser = subparsers.add_parser(
        "update",
        help="Update Kai Agent to the latest version",
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall Kai Agent",
        description="Remove Kai Agent from your system. Can keep configs/data for reinstall."
    )
