...
def schedule_cronjob(
    ...
    origin = None
    origin_platform = get_env("KAI_SESSION_PLATFORM")
    origin_chat_id = get_env("KAI_SESSION_CHAT_ID")
    if origin_platform and origin_chat_id:
        origin = {
            "platform": origin_platform,
            "chat_id": origin_chat_id,
            "chat_name": get_env("KAI_SESSION_CHAT_NAME"),
        }
...
def check_cronjob_requirements() -> bool:
    ...
    """
    return bool(
        os.getenv("KAI_INTERACTIVE") or os.getenv("HERMES_INTERACTIVE")
        or os.getenv("KAI_GATEWAY_SESSION") or os.getenv("HERMES_GATEWAY_SESSION")
        or os.getenv("KAI_EXEC_ASK") or os.getenv("HERMES_EXEC_ASK")
    )
