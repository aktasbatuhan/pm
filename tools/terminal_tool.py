...
def _transform_sudo_command(command: str) -> tuple[str, str | None]:
    ...
    if not sudo_password:
        ...
        if os.getenv("KAI_INTERACTIVE") or os.getenv("HERMES_INTERACTIVE"):
...
def terminal_tool(
    ...
    try:
        ...
        if background:
            ...
            session_key = get_env("KAI_SESSION_KEY")
            ...
            try:
                ...
                if check_interval and background:
                    ...
                    process_registry.pending_watchers.append({
                        ...
                        "session_key": session_key,
                        "platform": get_env("KAI_SESSION_PLATFORM"),
                        "chat_id": get_env("KAI_SESSION_CHAT_ID"),
                    })
