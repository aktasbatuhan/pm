...
PLATFORMS = {
    "cli":      {"label": "🖥️  CLI",       "default_toolset": "kai-cli"},
    "telegram": {"label": "📱 Telegram",   "default_toolset": "kai-telegram"},
    "discord":  {"label": "💬 Discord",    "default_toolset": "kai-discord"},
    "slack":    {"label": "💼 Slack",      "default_toolset": "kai-slack"},
    "email":    {"label": "📧 Email",      "default_toolset": "kai-email"},
}
...
def _prompt_toolset_checklist(platform_label: str, enabled: Set[str]) -> Set[str]:
    ...
    from kai_cli.curses_ui import curses_checklist
...
def tools_command(args=None, first_install: bool = False, config: dict = None):
    ...
    if getattr(args, "summary", False):
        ...
        print()
        return
    print(color("◆ Dash PM Tool Configuration", Colors.CYAN, Colors.BOLD))
