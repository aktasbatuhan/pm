...
SERVICE_NAME = "kai-gateway"
SERVICE_DESCRIPTION = "Dash PM Gateway - Messaging Platform Integration"
...
def run_gateway(verbose: bool = False, replace: bool = False):
    ...
    print("┌─────────────────────────────────────────────────────────┐")
    print("│           ◆ Dash PM Gateway Starting...                     │")
    print("├─────────────────────────────────────────────────────────┤")
...
def _setup_whatsapp():
    ...
    from kai_cli.main import cmd_whatsapp
    import argparse
