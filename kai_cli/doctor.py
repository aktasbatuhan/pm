...
from kai_cli.config import get_project_root, get_hermes_home, get_env_path
...
def run_doctor(args):
    ...
    try:
        from kai_cli.auth import get_nous_auth_status, get_codex_auth_status
    ...
    from kai_cli.config import get_env_value
