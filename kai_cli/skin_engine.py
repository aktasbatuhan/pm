...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Dash PM"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Session ended."              # Shown on exit
      response_label: " ◆ Kai "       # Response box header label
...
.. code-block:: python
    ...
    from kai_cli.skin_engine import get_active_skin, list_skins, set_active_skin
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Dash PM — steel blue and rose",
        "colors": {
            "banner_border": "#6A9EBE",
            "banner_title": "#EAEAEA",
            "banner_accent": "#6A9EBE",
            "banner_dim": "#4A7A9E",
            "banner_text": "#EAEAEA",
            "ui_accent": "#6A9EBE",
            "ui_label": "#BE6A9F",
            ...
            "prompt": "#EAEAEA",
            "input_rule": "#6A9EBE",
            "response_border": "#6A9EBE",
            "session_label": "#BE6A9F",
            "session_border": "#4A7A9E",
        },
        "spinner": {
            "waiting_faces": ["(◆)", "(◇)", "(⬡)", "(⬢)", "(◈)"],
            "thinking_faces": ["(◆)", "(◇)", "(⬡)", "(⬢)", "(◈)"],
            "thinking_verbs": ["analyzing", "scanning", "evolving", "researching", "computing"],
        },
        "branding": {
            "agent_name": "Dash PM",
            "welcome": "Dash PM ready. Type your message or /help for commands.",
            "goodbye": "Session ended.",
            "response_label": " ◆ Dash ",
            "prompt_symbol": "◆ ",
            "help_header": "Dash PM Commands",
        },
        "tool_prefix": "┊",
    },
    "ares": {
