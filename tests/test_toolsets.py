...
class TestToolsetConsistency:
    ...
    def test_kai_platforms_share_core_tools(self):
        """All kai-* platform toolsets should have the same tools."""
        platforms = ["kai-cli", "kai-telegram", "kai-discord", "kai-slack", "kai-email"]
